...
ServerEvents.recipes(event => {
    ...
    { name: "spell_power:critical_chance", max_level: 5, pigment_color: "spectrum:magenta_pigment", item_1: "minecraft:rabbit_foot", item_2: "tgacmod:haste_infused_catalyst", advancement: "spectrum:midgame/build_enchanting_structure" },
