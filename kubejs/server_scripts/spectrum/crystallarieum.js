...
ServerEvents.recipes(event => {
    ...
    event.recipes.modern_industrialization.chemical_reactor(16, 100)
        ...
        .fluidIn('spectrum:liquid_crystal', 100)
        .itemOut(`spectrum:small_globette_nether_bud`)
    event.recipes.modern_industrialization.industrial_crystallarieum(64, 800)
        .itemIn('spectrum:small_globette_nether_bud')
        .itemIn('minecraft:netherite_ingot')
        .fluidIn('modern_industrialization:red_ink', 6000)
        .itemOut('spectrum:large_globette_nether_bud')
        .itemOut('spectrum:small_globette_nether_bud', 0.5)
    event.recipes.modern_industrialization.industrial_crystallarieum(128, 800)
        .itemIn('spectrum:large_globette_nether_bud')
        .itemIn('minecraft:netherite_ingot')
        .fluidIn('modern_industrialization:red_ink', 6000)
        .itemOut('spectrum:globette_nether_cluster')
        .itemOut('spectrum:large_globette_nether_bud', 0.5)
    event.recipes.modern_industrialization.macerator(8, 100)
        .itemIn('spectrum:globette_nether_cluster')
        .itemOut('4x spectrum:pure_globette_nether')

    // globette_end
    event.recipes.modern_industrialization.chemical_reactor(16, 100)
        .itemIn('spectrum:paltaeria_fragments')
        .fluidIn('spectrum:liquid_crystal', 100)
        .itemOut(`spectrum:small_globette_end_bud`)
    event.recipes.modern_industrialization.industrial_crystallarieum(64, 800)
        .itemIn('spectrum:small_globette_end_bud')
        .itemIn('spectrum:paltaeria_fragments')
        .fluidIn('modern_industrialization:green_ink', 6000)
        .itemOut('spectrum:large_globette_end_bud')
        .itemOut('spectrum:small_globette_end_bud', 0.5)
    event.recipes.modern_industrialization.industrial_crystallarieum(128, 800)
        .itemIn('spectrum:large_globette_end_bud')
        .itemIn('spectrum:paltaeria_fragments')
        .fluidIn('modern_industrialization:green_ink', 6000)
        .itemOut('spectrum:globette_end_cluster')
        .itemOut('spectrum:large_globette_end_bud', 0.5)
    event.recipes.modern_industrialization.macerator(8, 100)
        .itemIn('spectrum:globette_end_cluster')
        .itemOut('4x spectrum:pure_globette_end')

    // globette
    event.recipes.modern_industrialization.chemical_reactor(16, 100)
        .itemIn('mythicmetals:prometheum_ingot')
        .fluidIn('spectrum:liquid_crystal', 100)
        .itemOut(`spectrum:small_globette_bud`)
    event.recipes.modern_industrialization.industrial_crystallarieum(64, 800)
        .itemIn('spectrum:small_globette_bud')
        .itemIn('mythicmetals:prometheum_ingot')
        .fluidIn('modern_industrialization:blue_ink', 6000)
        .itemOut('spectrum:large_globette_bud')
        .itemOut('spectrum:small_globette_bud', 0.5)
    event.recipes.modern_industrialization.industrial_crystallarieum(128, 800)
        .itemIn('spectrum:large_globette_bud')
        .itemIn('mythicmetals:prometheum_ingot')
        .fluidIn('modern_industrialization:blue_ink', 6000)
        .itemOut('spectrum:globette_cluster')
        .itemOut('spectrum:large_globette_bud', 0.5)
    event.recipes.modern_industrialization.macerator(8, 100)
        .itemIn('spectrum:globette_cluster')
        .itemOut('4x spectrum:pure_globette')
