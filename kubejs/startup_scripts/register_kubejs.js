...
StartupEvents.registry('item', event => {
    ...
    simpleItemAdd({ item: 'ingot_mold', stackSize:1})
    simpleItemAdd({ item: 'plate_mold', stackSize:1})
    simpleItemAdd({ item: 'gear_mold', stackSize:1})
    simpleItemAdd({ item: 'ring_mold', stackSize:1})
    simpleItemAdd({ item: 'rod_mold', stackSize:1})
    simpleItemAdd({ item: 'rotor_mold', stackSize:1})
    simpleItemAdd({ item: 'nugget_mold', stackSize:1})
