ItemEvents.tooltip(tooltip => {
    ////////////////////////////////////////////////////////////
        ...
        betterToolTip({ item: 'tatimod:ancient_sack', text: 'mif.magic.sacks.tooltip' })
        betterToolTip({ item: 'tatimod:precious_sack', text: 'mif.magic.sacks.tooltip' })
        betterToolTip({ item: 'tctimod:cursed_sack', text: 'mif.magic.sacks.tooltip' })
        betterToolTip({ item: 'tctimod:lost_sack', text: 'mif.magic.sacks.tooltip' })
